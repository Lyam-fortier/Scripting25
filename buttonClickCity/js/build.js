...
function legobuild() {
  console.log("lego building is working!");
  //add one to the building variable
  buildings++;
  document.getElementById("city").innerHTML =
    "you have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock1.png' alt='lego building'>";
}
...
function apartbuild() {
  console.log("Lego Apartment is working");
  buildings++;
  document.getElementById("city").innerHTML =
    "you have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock2.png' alt='lego building'>";
}
...
function Legopolice() {
  console.log("lego police is on the scene");
  buildings++;
  document.getElementById("city").innerHTML =
    "you have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock3.png' alt='lego building'>";
}
//Create a function for the third button that prints a message with the number of buildings and the graphic for the second building
function LegoAdd() {
  console.log(
    "A man has fallen into the river in lego city! build various expenisve lego sets!"
  );
  buildings++;
  document.getElementById("city").innerHTML =
    "you have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/Building4.png' alt='lego building'>";
}
