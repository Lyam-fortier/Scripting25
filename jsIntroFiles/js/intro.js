...
document.getElementById("column1").innerHTML = "<p>Za warudo!</p>";
...
document.getElementById("column2").style.fontSize;
("32pt");
...
animal = "bluebird";
if (animal == "dragon") {
  console.log("you battle with the dragon");
} else {
...
//then change the inner html of column3 to say "<p>you are using fists"
//else if the weapon equals squids then give a diffrent message
//oterwise (else)
//then give a diffrent message
//if(){}else id(){}else{}
if (weapon == "Fists") {
  document.getElementById("column3").innerHTML +=
    "<p>you are using " + weapon + "</p>";
} else if (weapon == "Squids") {
  document.getElementById("column3").innerHTML +=
    "<p>you are using " + weapon + "</p>";
} else {
  document.getElementById("column3").innerHTML += "<p>no weapon equipped</p>";
}
...
//change the content in the third colum
document.getElementById("column3").innerHTML +=
